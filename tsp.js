...
function formatDirections(gdir, mode) {
    ...
    for (var i = 0; i < gdir.legs.length; ++i) {
        ...
        dragStr += "<li id='" + i + "' class='ui-state-"
            ...
            + "<img src='newicons/black" + number + ".png' /></td><td class='middle'>"
    ...
    if (mode == 0) {
        ...
        dragStr += "<li id='" + 0 + "' class='ui-state-disabled'>"
            + "<table class='dragTable'><tr><td><img src='newicons/black" + 1
        ...
        retStr += "\t<tr class='heading'><td class='heading'>"
            + "<div class='centered-directions'><img src='newicons/black"
            + (gdir.legs.length + 1) + ".png'></div></td>" + "<td class='heading'>"
